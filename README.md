...
an understanding of the problem with side channels and covert channels.
...
- `overview` contains slides to give the students an understanding of the 
  problem of side-channels.
